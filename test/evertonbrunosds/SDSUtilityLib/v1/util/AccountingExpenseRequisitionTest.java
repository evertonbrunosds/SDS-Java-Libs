...
/**
 * Classe responsável por efetuar testes na requisição de despesa contábil.
...
public class AccountingExpenseRequisitionTest {
    ...
    @Test
    public void criandoRequisicaoDeDespesaContabilComValorNegativo() {
    ...
    public void verificaIdependênciaDeRequisicaoDespesaContabilDuplicado() {
        ...
        final AccountingExpenseRequisition afr2 = afr1.duplicate();
    ...
    public void compareNotNullWithNotNull() {
        ...
        final AccountingExpenseRequisition afr2 = afr1.duplicate();
        assertEquals(0, AccountingExpenseRequisition.compare(afr1, afr2));
        afr1.setAmount(7);
        assertEquals(1, AccountingExpenseRequisition.compare(afr1, afr2));
        afr2.setAmount(10);
        assertEquals(-1, AccountingExpenseRequisition.compare(afr1, afr2));
    }
    ...
    public void compareNullWithNull() {
        assertEquals(0, AccountingExpenseRequisition.compare(null, null));
    }

    @Test
    public void compareNotNullWithNull() {
        final AccountingExpenseRequisition afr = new AccountingExpenseRequisition(5, new AccountingExpense(-300.93));
        assertEquals(1, AccountingExpenseRequisition.compare(afr, null));
    }

    @Test
    public void compareNullWithNotNull() {
        final AccountingExpenseRequisition afr = new AccountingExpenseRequisition(5, new AccountingExpense(-300.93));
        assertEquals(-1, AccountingExpenseRequisition.compare(null, afr));
    }

    @Test
    public void compareToNotNull() {
        final AccountingExpenseRequisition afr1 = new AccountingExpenseRequisition(2, new AccountingExpense(3));
        AccountingExpenseRequisition afr2 = afr1.duplicate();
